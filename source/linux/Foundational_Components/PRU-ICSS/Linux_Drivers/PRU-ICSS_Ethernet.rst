...
.. note::
   ...
   Starting with the SDK 11.1 release, the Linux driver is not backwards compatible
   with PRU Ethernet firmware from previous SDK releases. The Linux driver provided
   with this release should be used with the PRU firmware from this release.
   Similarly, the PRU Ethernet firmware from this release is not backwards compatible
   with Linux drivers from before the SDK 11.1 release.
