...
.. ifconfig:: CONFIG_part_variant in ('AM57X')
   ...
   .. note::
      From 11.01 SDK release, backward compatibility is not feasible and hence
      not maintained. Which means firmware and driver provided from this release
      need to be used together. Old driver new firmware and new driver old firmware
      will not work.

.. ifconfig:: CONFIG_part_variant in ('AM335X', 'AM437X')

   .. note::
      From 11.02 SDK release, backward compatibility is not feasible and hence
      not maintained. Which means firmware and driver provided from this release
      need to be used together. Old driver new firmware and new driver old firmware
      will not work.
