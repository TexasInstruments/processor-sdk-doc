...
The above steps are useful during development but unusable in a production environment. The following are pointers help build a final image which does not require the above steps.
