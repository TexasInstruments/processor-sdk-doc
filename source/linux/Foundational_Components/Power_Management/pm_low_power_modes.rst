...
.. ifconfig:: CONFIG_part_variant in ('AM62AX' , 'AM62PX')
   ...
   .. rubric:: Following commands can be used to enable wakeup from mcu_mcan0, mcu_mcan1,
               mcu_uart0 and wkup_uart0 respectively.

   .. code-block:: console

      root@<machine>:~# devmem2 0x4084038 0x20050000
      root@<machine>:~# devmem2 0x4084040 0x20050000
      root@<machine>:~# devmem2 0x4084014 0x20050000
      root@<machine>:~# devmem2 0x4084024 0x20050000
