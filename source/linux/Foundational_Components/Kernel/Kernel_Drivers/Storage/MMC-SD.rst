...
.. ifconfig:: CONFIG_part_family in ('AM62X_family')
   ...
   **Missing eMMC support**
   ...
   will not work on AM62SIP SK. If eMMC support is required, apply the following commit:
   78e6abff3220 "PENDING: arm64: dts: ti: k3-am6254xxl-sk: Move pinmux to board level" found in TI-Linux ti-linux-6.12.y branch
   to enable eMMC support in Linux.
