...
.. ifconfig:: CONFIG_part_variant in ('J721E','J784S4', 'J742S2', 'J721S2', 'J7200', 'J722S', 'AM62X', 'AM62AX', 'AM62LX', 'AM62PX')

   Accessing an SD card from a host PC using UMS command
   =====================================================
   ...
   for accessing storage devices like SD/MMC from a USB host such as host
   PC.
   ...
   **partnum**
   ...
   .. note::
      ...
      the controller is in host mode, then it needs to be reconfigured to
