...
does not cover all the per-platform corner-cases. For any  issues or questions
on this guide, reach out to: `Help e2e <https://e2e.ti.com//>`__.
...
.. note::
   ...
   create a partition in UDA, go :ref:`here <mmc-create-partitions-in-emmc-uda-from-linux>`
