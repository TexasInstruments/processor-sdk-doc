...
+----------------------------------------------+----------------------------------------------------------------------+
| PSDK Linux AM62L Installer (Linux version)  | ti-processor-sdk-linux-am62lxx-evm-<version>-Linux-x86-Install.bin   |
+----------------------------------------------+----------------------------------------------------------------------+
...
.. note::
   ...
   package `[Use Link] <https://software-dl.ti.com/mcu-plus-sdk/esd/AM62L/10_01_00_33/exports/docs/api_guide_am62lxx/index.html>`__.

**Instructions to set-up CCS**

-  Refer `[Use Link] <https://software-dl.ti.com/mcu-plus-sdk/esd/AM62L/10_01_00_33/exports/docs/api_guide_am62lxx/CCS_SETUP_PAGE.html>`__
