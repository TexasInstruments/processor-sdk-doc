...
Processor SDK 11.00 Release has following new features:
  ...
  * This is the First with LTS 2025 with kernel 6.12 and u-boot 2025.01
  * ATF 2.12+
  * OPTEE 4.5.0+
  * Yocto Scarthgap/5.0
  * MCU_1_1 in split mode
  * HSM support
  * Graceful shutdown of MCU cores 
  * HMAC support  
  * CSI ECC support added
...
U-Boot
------
| Head Commit: acd91d73601810374d16a1f17505ab2e72e31f75d PENDING: mmc: am654_sdhci: Unset HIGH_SPEED_ENA for MMC_HS_52
| Date: Mon Mar 24 19:23:34 2025 -0500
| uBoot Version: 2025.001
| uBoot Description: 11.00.09
...
| Date: Mon Mar 24 15:16:34 2025 -0500
| Kernel Version: 6.12.17
| Kernel Description: 11.00.09
...
| Date: Thu Mar 20 18:43:04 2025 +0530
...
| Head Commit: 513554ef3cfb7cb14ec7e1b702598771771a0afb recipes-core: packagegroups: Drop references of purged components
| Date: 

| Repo: https://github.com/TexasInstruments/meta-tisdk
| Branch: scarthgap
| Release Tag: Tue Mar 18 19:18:09 2025 +0530
|
...
.. csv-table::
  ...
  "LCPD-37705","crypto perf failure ","j7200-evm,j722s_evm-fs",""
  ...
  "LCPD-37507","DSS causes a freeze of processes every 10 seconds for about 200ms","am68_sk-fs","1. When HDMI is connected the GPU benchmarks freezes every 10 seconds for 200 ms (tested for weston-simple-egl), to prevent this disable DisplayPort in device tree. or 2. Connect display monitor as well, when running benchmark test."
...
.. csv-table::
  ...
  JACINTOREQ-3987, "Linux SDK shall support ADC: 12-bit, 4MSPS analog to digital converter", "J784S4", 10.01.00, Dropped 
